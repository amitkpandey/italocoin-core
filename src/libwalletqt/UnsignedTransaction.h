...
public:
    ...
    enum Priority {
        Priority_Low    = Italocoin::UnsignedTransaction::Priority_Low,
        Priority_Medium = Italocoin::UnsignedTransaction::Priority_Medium,
        Priority_High   = Italocoin::UnsignedTransaction::Priority_High
    };
    Q_ENUM(Priority)
