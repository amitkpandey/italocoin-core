...
# cleaning "auto-generated" bititalocoin directory on "make distclean"
...
TRANSLATIONS =  \ # English is default language, no explicit translation file
                $$PWD/translations/italocoin-core.ts \ # translation source (copy this file when creating a new translation)
                $$PWD/translations/italocoin-core_ar.ts \ # Arabic
                $$PWD/translations/italocoin-core_pt-br.ts \ # Portuguese (Brazil)
                $$PWD/translations/italocoin-core_de.ts \ # German
                $$PWD/translations/italocoin-core_eo.ts \ # Esperanto
                $$PWD/translations/italocoin-core_es.ts \ # Spanish
                $$PWD/translations/italocoin-core_fi.ts \ # Finnish
                $$PWD/translations/italocoin-core_fr.ts \ # French
                $$PWD/translations/italocoin-core_hr.ts \ # Croatian
                $$PWD/translations/italocoin-core_id.ts \ # Indonesian
                $$PWD/translations/italocoin-core_hi.ts \ # Hindi
                $$PWD/translations/italocoin-core_it.ts \ # Italian
                $$PWD/translations/italocoin-core_ja.ts \ # Japanese
                $$PWD/translations/italocoin-core_nl.ts \ # Dutch
                $$PWD/translations/italocoin-core_pl.ts \ # Polish
                $$PWD/translations/italocoin-core_ru.ts \ # Russian
                $$PWD/translations/italocoin-core_sv.ts \ # Swedish
                $$PWD/translations/italocoin-core_zh-cn.ts \ # Chinese (Simplified-China)
                $$PWD/translations/italocoin-core_zh-tw.ts \ # Chinese (Traditional-Taiwan)
                $$PWD/translations/italocoin-core_he.ts \ # Hebrew
                $$PWD/translations/italocoin-core_ko.ts \ # Korean
                $$PWD/translations/italocoin-core_ro.ts \ # Romanian
                $$PWD/translations/italocoin-core_da.ts \ # Danish
                $$PWD/translations/italocoin-core_cs.ts \ # Czech
                $$PWD/translations/italocoin-core_sk.ts \ # Slovak
                $$PWD/translations/italocoin-core_sl.ts \ # Slovenian
                $$PWD/translations/italocoin-core_rs.ts \ # Serbian
                $$PWD/translations/italocoin-core_cat.ts \ # Catalan
                $$PWD/translations/italocoin-core_tr.ts \ # Turkish
                $$PWD/translations/italocoin-core_ua.ts \ # Ukrainian
                $$PWD/translations/italocoin-core_pt-pt.ts \ # Portuguese (Portugal)
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libitalocoin-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
...
DISTFILES += \
    notes.txt \
    italocoin/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = italocoin-core.rc
