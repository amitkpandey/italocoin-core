; Italocoin Helium Hydra GUI Wallet Installer for Windows
...
Source: "bin\italocoin-wallet-gui.exe"; DestDir: "{app}"; Flags: comparetimestamp
...
Source: "italocoin-wallet-gui.log"; DestDir: "{app}"; Flags: comparetimestamp; Permissions: users-modify

; Italocoin CLI wallet
Source: "bin\italocoin-wallet-cli.exe"; DestDir: "{app}"; Flags: comparetimestamp

; Italocoin wallet RPC interface implementation
Source: "bin\italocoin-wallet-rpc.exe"; DestDir: "{app}"; Flags: comparetimestamp

; Italocoin daemon
Source: "bin\italocoind.exe"; DestDir: "{app}"; Flags: comparetimestamp

; Italocoin daemon wrapped in a batch file that stops before the text window closes, to see any error messages
Source: "italocoin-daemon.bat"; DestDir: "{app}"; Flags: comparetimestamp;

; Italocoin blockchain utilities
Source: "bin\italocoin-blockchain-export.exe"; DestDir: "{app}"; Flags: comparetimestamp
Source: "bin\italocoin-blockchain-import.exe"; DestDir: "{app}"; Flags: comparetimestamp

; was present in 0.10.3.1, not present anymore in 0.11.1.0
; Source: "bin\italocoin-utils-deserialize.exe"; DestDir: "{app}"; Flags: comparetimestamp
